...
```{r constants}
course_date <- "2023-11-08"
course_level <- "advanced"
course_name <- glue::glue("r-cubed-{course_level}")
fetch_precourse <- switch(
  course_level,
  intro = fetch_precourse_intro,
  inter = fetch_precourse_inter,
  advanced = fetch_precourse_advanced
)
...
```{r, eval=FALSE}
admin_create_planning_issue(course_name, course_date, host = "github")
browseURL(glue::glue("https://github.com/rostools/{course_name}"))
```
